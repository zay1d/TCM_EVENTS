...
events.get('/:id', ah(async (req, res) => {
...
events.post('/', requireOwner, ah(async (req, res) => {
...
events.put('/:id', requireOwner, ah(async (req, res) => {
...
events.delete('/:id', requireOwner, ah(async (req, res) => {
